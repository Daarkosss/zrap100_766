"! @testing BDEF:ZRAP100_R_TravelTP_766
CLASS zrap100_tc_travel_eml_766 DEFINITION PUBLIC FINAL CREATE PUBLIC
  FOR TESTING
  RISK LEVEL HARMLESS
  DURATION SHORT.
...
CLASS zrap100_tc_travel_eml_766 IMPLEMENTATION.
  METHOD class_setup.
    " create the test doubles for the underlying CDS entities
    cds_test_environment = cl_cds_test_environment=>create_for_multiple_cds(
                      i_for_entities = VALUE #(
                        ( i_for_entity = 'ZRAP100_R_TravelTP_766' ) ) ).
  ...
  METHOD create_with_action.
    ...
    MODIFY ENTITIES OF ZRAP100_R_TravelTP_766
     ENTITY Travel
    ...
    SELECT * FROM ZRAP100_R_TravelTP_766 INTO TABLE @DATA(lt_travel). "#EC CI_NOWHERE
