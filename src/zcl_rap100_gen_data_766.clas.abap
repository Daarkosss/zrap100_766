CLASS zcl_rap100_gen_data_766 DEFINITION
PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_766 IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE '766',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atrav766.
    DELETE FROM zrap100_dtrav766.

    "insert travel demo data
    INSERT zrap100_atrav766 FROM (
        SELECT
          ...
          FIELDS
            ...
            ORDER BY travel_id DESCENDING UP TO 10 ROWS
      ).
    COMMIT WORK.
