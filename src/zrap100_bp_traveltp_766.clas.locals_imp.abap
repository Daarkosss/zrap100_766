CLASS lhc_zrap100_r_traveltp_766 DEFINITION INHERITING FROM cl_abap_behavior_handler.
  PRIVATE SECTION.
    CONSTANTS:
...
CLASS lhc_zrap100_r_traveltp_766 IMPLEMENTATION.
  ...
  METHOD earlynumbering_create.
    DATA:
      entity           TYPE STRUCTURE FOR CREATE zrap100_r_traveltp_766,
    ...
    ELSE.
      ...
      SELECT SINGLE FROM zrap100_atrav766 FIELDS MAX( travel_id ) AS travelid INTO @travel_id_max.
      "Get max travel ID from draft table
      SELECT SINGLE FROM zrap100_dtrav766 FIELDS MAX( travelid ) INTO @DATA(max_travelid_draft).
  ...
  METHOD setstatustoopen.
    ...
    READ ENTITIES OF zrap100_r_traveltp_766 IN LOCAL MODE
     ENTITY travel
    ...
    MODIFY ENTITIES OF zrap100_r_traveltp_766 IN LOCAL MODE
      ENTITY travel
        UPDATE SET FIELDS
...
**************************************************************************
  METHOD deductDiscount.
    DATA travels_for_update TYPE TABLE FOR UPDATE ZRAP100_R_TravelTP_766.
...
**************************************************************************
  METHOD copyTravel.
    DATA:
      travels TYPE TABLE FOR CREATE zrap100_r_traveltp_766\\travel.
